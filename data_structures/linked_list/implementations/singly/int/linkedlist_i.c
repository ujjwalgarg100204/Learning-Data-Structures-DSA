...
#include "../node/int/node_singly_i.h"
...
int removeFirst(LinkedList *list) {
    ...
    int headData = getData(list->head);
...
int removeAt(LinkedList *list, int index) {
    ...
    int element = getData(getNext(beforeIndex));
 ...
 * Space Complexity: O(1)
 */
int removeLastOccur(LinkedList *list, int element) {
