#ifndef LEARNING_DATA_STRUCTURES_DSA_DYNAMIC_ARRAY_C_H
#define LEARNING_DATA_STRUCTURES_DSA_DYNAMIC_ARRAY_C_H
 ...
 */
void addAt(DynamicArray *arr, int index, char element);
 ...
 */
void addLast(DynamicArray *arr, char element);
 ...
 */
int lastIndexOf(const DynamicArray *arr, char val);
 ...
 */
int indexOf(const DynamicArray *arr, char val);
 ...
 */
bool removeFirstOccur(DynamicArray *arr, char val);
 ...
 */
char setAt(DynamicArray *arr, int index, char val);
...
#endif //LEARNING_DATA_STRUCTURES_DSA_DYNAMIC_ARRAY_C_H
